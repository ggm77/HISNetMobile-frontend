...
import { ApiError, createReservation, facilities as fetchFacilities, facilityAvailability, type Facility, type FacilityCategory, type Slot } from '../api'
...
export default function Reserve({ go, toast }: { go: (r: Route) => void; toast: (s: string) => void }) {
